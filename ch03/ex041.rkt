...
; you have solved exercise 39, define the constants BACKGROUND and
; Y-AUTOMOBILE. Then assemble all the function definitions, including their
; tests. When your program runs to your satisfaction, add a tree to the
; scenery. We used
