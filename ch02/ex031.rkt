...
; inputs. Run letter on three inputs of your choice.  Here is a letter-writing
; batch program that reads names from three files and writes a letter to one:
...
(define IN-FST "ex031_in_fst.txt")
(define IN-LST "ex031_in_lst.txt")
(define SIGATURE "ex031_sigature.txt")
(define OUT "ex031_out.txt")

(write-file IN-FST "Mathew")
(write-file IN-LST "Fisler")
(write-file SIGATURE "Felleisen")
(main IN-FST IN-LST SIGATURE OUT)
